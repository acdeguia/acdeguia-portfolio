              ...
              <ul className="flex demo-links">
                ...
                <li>
                  <a className="demo-link" href={project.link}><svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.45714 5.91431H1.51429C1.23025 5.91431 1 6.14456 1 6.42859V17.4857C1 17.7698 1.23025 18 1.51429 18H14.1143C14.3983 18 14.6286 17.7698 14.6286 17.4857V11.3143" stroke="#FF6E4A" stroke-linecap="round" />
                    <line x1="6.65723" y1="12.4684" x2="12.6358" y2="6.48982" stroke="#FF6E4A" stroke-linecap="round" />
                    <path d="M15.0241 3.09897C15.3481 3.03399 15.6485 3.28707 15.6393 3.61741L15.5097 8.31347C15.4978 8.74403 14.9936 8.97011 14.6642 8.69254L10.1877 4.92022C9.85834 4.64266 9.99567 4.1074 10.418 4.0227L15.0241 3.09897Z" fill="#FF6E4A" />
                  </svg>
                  </a>
                </li>
                <li>
